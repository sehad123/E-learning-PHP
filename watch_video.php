   ...
   if ($user_id != '') {
      ...
      if ($select_content->rowCount() > 0) {
         ...
         if ($select_comment->rowCount() > 0) {
            ...
            $insert_comment = $conn->prepare("INSERT INTO `comments`(id, content_id, user_id, tutor_id, comment, date) VALUES(?,?,?,?,?,?)");
            $insert_comment->execute([$id, $content_id, $user_id, $tutor_id, $comment_box, $currentDate]);
